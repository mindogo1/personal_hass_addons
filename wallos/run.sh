...
PY
        ...
        # Prepare persistent paths (map /config to app data paths)
        mkdir -p /config/db
        ...
        # If APP_URL provided, try to write base URL to .env or config.php if known
        # (Wallos uses Laravel-style .env historically; try to set APP_URL safely if present.)
